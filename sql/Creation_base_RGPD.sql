...
--
-- Serveur: localhost
-- Généré le : Ven 20 Avril 2018 à 16:59
...
(10, 'Identification du traitement', ''),
(20, 'Acteurs', ''),
(30, 'DonnÃ©es', ''),
(35, 'Droits d''accÃ¨s (Ã  l''application ou aux fichiers)', 'Cf. notice -> Action 4 -> Point C'),
(37, 'Analyse d''impact sur la protection des donnÃ©es', 'Cf. notice -> Action 4 -> Point D'),
(40, 'Limiter la conservation, les finalitÃ©s, et minimiser les donnÃ©es', 'Cf. notice -> Action 4 -> Points E, F et G'),
(55, 'Respect des droits des personnes concernÃ©es', 'Cf. notice -> Action 4 -> Point H'),
(56, 'Sous-Traitance', ''),
...
('destinationDonnees', 210, 'Destination des donnÃ©es (flux de sortie)', '', 'U', '', 100, 'N', 30, 'N'),
('detailFinalite', 70, 'DÃ©tail de la finalitÃ©', 'Exemple : fondement juridique...', 'M', '', 400, 'N', 10, 'N'),
('droitAccesOk', 510, 'Droit d''accÃ¨s aux informations : processus en place ?', '', 'L', 'OK', 0, 'N', 55, 'N'),
('droitAccesProcessus', 500, 'Droit d''accÃ¨s aux informations : processus pour rÃ©pondre Ã  ce droit.', 'Cf. notice -> Action 4 -> Point H', 'M', '', 250, 'N', 55, 'N'),
('droitAccesRevisionComment', 226, 'ModalitÃ©s', 'Comment cette rÃ©vision sera-t-elle opÃ©rÃ©e ?', 'M', '', 150, 'N', 35, 'N'),
('droitAccesRevisionDate', 222, 'Date de la prochaine rÃ©vision des droits, et pÃ©riodicitÃ©', '', 'U', '', 60, 'N', 35, 'N'),
('droitAccesRevisionQui', 224, 'Responsable de la rÃ©vision', 'Remarque : cela peut Ãªtre le rÃ´le du rÃ©fÃ©rent', 'U', '', 40, 'N', 35, 'N'),
('droitEffacementOk', 550, 'Droit Ã  l''effacement ("Droit Ã  l''oubli") des DCP : processus en place ?', '', 'L', 'OK', 0, 'N', 55, 'N'),
('droitEffacementProcessus', 540, 'Droit Ã  l''effacement ("Droit Ã  l''oubli") des DCP : processus pour rÃ©pondre Ã  ce droit.', 'Cf. notice -> Action 4 -> Point H', 'M', '', 250, 'N', 55, 'N'),
('droitOppositionOk', 590, 'Droit d''opposition (=retrait du consentement) : processus en place ?', '', 'L', 'OK', 0, 'N', 55, 'N'),
('droitOppositionProcessus', 580, 'Droit d''opposition (=retrait du consentement) : processus pour rÃ©pondre Ã  ce droit.', 'Cf. notice -> Action 4 -> Point H', 'M', '', 250, 'N', 55, 'N'),
('droitPortabiliteOk', 570, 'Droit Ã  la portabilitÃ© des donnÃ©es : processus en place ?', '', 'L', 'OK', 0, 'N', 55, 'N'),
('droitPortabiliteProcessus', 560, 'Droit Ã  la portabilitÃ© des donnÃ©es : processus pour rÃ©pondre Ã  ce droit.', 'Cf. notice -> Action 4 -> Point H', 'M', '', 250, 'N', 55, 'N'),
('droitRectifOk', 530, 'Droit de rectification des DCP : processus en place ?', '', 'L', 'OK', 0, 'N', 55, 'N'),
('droitRectifProcessus', 520, 'Droit de rectification des DCP : processus pour rÃ©pondre Ã  ce droit.', 'Cf. notice -> Action 4 -> Point H\r\nDCP = donnÃ©es Ã  caractÃ¨re personnel.', 'M', '', 250, 'N', 55, 'N'),
('dureeConservation', 170, 'DurÃ©e de conservation des donnÃ©es', 'DurÃ©e, dÃ©finie par les services eux-mÃªme, durant laquelle les donnÃ©es sont utiles dâ€™un point de vue opÃ©rationnel.', 'M', '', 30, 'N', 30, 'N'),
('finalite', 50, 'FinalitÃ©e', 'Objectif principal. Exemples de finalitÃ© : gestion des recrutements, gestion des activitÃ©s scolaires, surveillance des locaux, etc...', 'M', '', 400, 'O', 10, 'N'),
('garantiesHorsUE', 780, 'Type(s) de Garanties', '', 'M', '', 400, 'N', 70, 'N'),
('limitationConservation', 270, 'MÃ©thode mise en oeuvre pour limiter la conservation des donnÃ©es', 'Cf. notice -> Action 4 -> Point E', 'M', '', 400, 'N', 40, 'N'),
('limitationFinalites', 290, 'MÃ©thode mise en oeuvre pour limiter les finalitÃ©s', 'Cf. notice -> Action 4 -> Point F', 'M', '', 400, 'N', 40, 'N'),
...
('minimisationDonnees', 310, 'MÃ©thode mise en oeuvre pour minimiser les donnÃ©es', 'Cf. notice -> Action 4 -> Point G', 'M', '', 400, 'N', 40, 'N'),
('nom', 10, 'Nom', '', 'U', '', 255, 'O', 10, 'N'),
('origineDonnees', 200, 'Origine des donnÃ©es (flux d''entrÃ©e)', '', 'U', '', 100, 'N', 30, 'N'),
('paysHorsUE', 770, 'Pays', '', 'M', '', 200, 'N', 70, 'N'),
('PIA_realisee', 228, 'PIA ou EIVP rÃ©alisÃ©e', 'Si votre traitement est "trÃ¨s prioritaire" vous devez, Ã  priori (terme de la CNIL), conduire une analyse d''impact sur la protection des donnÃ©es (PIA : Privacy Impact Assesment), avant de commencer les opÃ©rations de traitement.', 'L', 'ON', 1, 'N', 37, 'N'),
('PIA_resultat', 229, 'RÃ©sultat de l''analyse', '', 'M', '', 200, 'N', 37, 'N'),
...
('priorite', 55, 'PrioritÃ©', 'DÃ©terminer cette prioritÃ© Ã  l''aide du paragraphe "PrioritÃ© du traitement" de la notice.', 'L', 'PRIORITE', 20, 'O', 10, 'N'),
('reference', 20, 'RÃ©f.', '', 'U', '', 20, 'O', 10, 'N'),
('referent', 120, 'RÃ©fÃ©rent', '"Super utilisateur" de l''application, responsable des droits d''accÃ¨s, garant du respect des obligations du RGPD.', 'U', '', 40, 'O', 20, 'N'),
('remarqueSousTrt', 630, 'Remarque(s)', '', 'M', '', 400, 'N', 56, 'N'),
('representant', 110, 'ReprÃ©sentant', 'Personne dÃ©signÃ©e par le responsable du traitement qui le reprÃ©sente en ce qui concerne leurs obligations respectives en vertu du RGPD (ex: responsable du service)', 'U', '', 40, 'N', 20, 'N'),
...
('statutLimitationConservation', 280, 'Mise en oeuvre terminÃ©e ?', '', 'L', 'OK', 1, 'N', 40, 'N'),
('statutLimitationFinalites', 300, 'Mise en oeuvre terminÃ©e ?', '', 'L', 'OK', 1, 'N', 40, 'N'),
('statutMinimisationDonnees', 320, 'Mise en oeuvre terminÃ©e ?', '', 'L', 'OK', 1, 'N', 40, 'N');
...
('dsi', '2018-04-19 23:40:36'),
('dsi', '2018-04-20 00:03:35'),
('dsi', '2018-04-20 00:04:13'),
('dsi', '2018-04-20 00:12:00'),
('dsi', '2018-04-20 09:11:00'),
('dsi', '2018-04-20 09:53:15'),
('dsi', '2018-04-20 10:37:22'),
('admin', '2018-04-20 10:37:48'),
('dsi', '2018-04-20 10:38:45'),
('dsi', '2018-04-20 10:39:46'),
('dsi', '2018-04-20 11:04:52'),
('dsi', '2018-04-20 11:15:57'),
('admin', '2018-04-20 11:31:50'),
('dsi', '2018-04-20 11:32:30'),
('dsi', '2018-04-20 11:33:35'),
('dsi', '2018-04-20 11:33:57'),
('dsi', '2018-04-20 11:36:36'),
('dsi', '2018-04-20 11:57:12'),
('dsi', '2018-04-20 11:59:40'),
('dsi', '2018-04-20 12:04:33'),
('dsi', '2018-04-20 13:42:00'),
('dsi', '2018-04-20 13:46:57'),
('dsi', '2018-04-20 13:53:29'),
('admin', '2018-04-20 13:53:41'),
('dsi', '2018-04-20 13:54:36'),
('dsi', '2018-04-20 14:42:23'),
('admin', '2018-04-20 14:42:39'),
('dsi', '2018-04-20 14:49:28'),
('admin', '2018-04-20 14:49:52'),
('dsi', '2018-04-20 14:55:07'),
('dsi', '2018-04-20 15:24:47'),
('admin', '2018-04-20 15:31:09'),
('dsi', '2018-04-20 15:38:07'),
('dsi', '2018-04-20 15:41:08'),
('admin', '2018-04-20 15:43:20'),
('ydeydier', '2018-04-20 15:43:35'),
('dsi', '2018-04-20 15:43:56'),
('dsi', '2018-04-20 16:44:33'),
('dsi', '2018-04-20 16:58:34');
...
CREATE TABLE IF NOT EXISTS `traitement` (
  ...
  `PIA_realisee` char(3) DEFAULT NULL,
  ...
  `droitOppositionOk` char(2) DEFAULT NULL,
  ...
  `droitPortabiliteOk` char(2) DEFAULT NULL,
  `droitRectifProcessus` varchar(250) NOT NULL,
  `droitRectifOk` char(2) NOT NULL,
...
INSERT INTO `traitement` (`idTraitement`, `timestamp`, `corbeille`, `quimaj`, `nom`, `reference`, `service`, `finalite`, `priorite`, `localisation`, `detailFinalite`, `responsable`, `representant`, `referent`, `presenceSousTrce`, `categorieDonneesNonSens`, `categorieDonneesSens`, `dureeConservation`, `presenceDonneesSensibles`, `PIA_realisee`, `PIA_resultat`, `origineDonnees`, `destinationDonnees`, `droitAccesRevisionDate`, `droitAccesRevisionQui`, `droitAccesRevisionComment`, `droitAccesProcessus`, `droitAccesOk`, `droitEffacementProcessus`, `droitEffacementOk`, `limitationFinalites`, `statutLimitationFinalites`, `minimisationDonnees`, `statutMinimisationDonnees`, `droitOppositionProcessus`, `droitOppositionOk`, `limitationConservation`, `statutLimitationConservation`, `droitPortabiliteProcessus`, `droitPortabiliteOk`, `droitRectifProcessus`, `droitRectifOk`, `mesuresTechniques`, `mesuresOrga`, `complementMesures`, `sousTraitants`, `responsableContratSousTrt`, `remarqueSousTrt`, `destinataireHorsUE`, `paysHorsUE`, `garantiesHorsUE`) VALUES
(1, '2018-04-20 15:43:42', 'N', 'ydeydier', 'SONATE', 'REF_1', 'DCLS - CCAS', 'Logiciel CCAS / CIAS, accueil, aides lÃ©gales et facultatives, logements, suivi social et RSA, portage de repas, aides Ã  domicile', '', 'Local', '', 'Monsieur le Maire', 'Fabienne SIONNEAU', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Editeur ARPEGE', 'La DSI / Resp. Application', 'HÃ©bergement en local Ã  la Mairie.\r\nContrat de service pour la maintenance et le support (avec un accÃ¨s Ã  distance).', 'Non', '', ''),
