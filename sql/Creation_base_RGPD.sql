...
--
-- Serveur: localhost
-- Généré le : Jeu 07 Novembre 2019 à 14:34
...
('consentementDelai', 260, 'DÃ©lais de mise en oeuvre', 'Si cette preuve n''est pas effective, quel dÃ©lai vous imposez-vous pour se conformer au RGPD sur ce point ?', 'M', '', 200, 'N', 38, 'N'),
...
('droitViolation', 592, 'Quelle est la procÃ©dure et le dÃ©lai pour traiter les droits des personnes sur la violation des donnÃ©es ?', '', 'M', '', 250, 'N', 55, 'N'),
...
('limitationConservation', 275, 'Dans le cas oÃ¹ ce n''est pas effectif, que manque-t-il pour que ce soit le cas et quel dÃ©lai envisagez-vous ?', '', 'M', '', 300, 'N', 40, 'N'),
...
('sousTraitants', 610, 'Sous- traitant(s) et objet de la sous-traitance', '', 'M', '', 300, 'N', 56, 'N'),
...
(1, '2018-10-23 17:59:55', 'N', 'fsionneau', 'SONATE', 'REF_1', 1, 'Logiciel CCAS / CIAS, accueil, aides lÃ©gales et facultatives, logements, suivi social et RSA, portage de repas, aides Ã  domicile', '', 'Local', 'Logiciel mÃ©tier', '', 'Monsieur le Maire', 'Fabienne XXXXXX', '', '', '', '', '', 'OUI', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Editeur ARPEGE', 'La DSI / Resp. Application', '', '');
